  ...
  data(){
    return{
      portablearr:[{
        ...
        price:"NTD$5,790",
        gotoweb:"/product/embertonforest",
      },{
        ...
        title:"TUFTON (古銅黑)",
        price:"NTD$18,900",
        gotoweb:"/product/tuftonbronzeblack",
      },],
    }
  }
};
